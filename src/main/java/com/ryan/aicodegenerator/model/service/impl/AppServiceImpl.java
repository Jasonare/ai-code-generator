...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    @Override
    public Page<App> pageQuery(AppQueryRequest appQueryRequest) {
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        if (!sourceDir.exists() || !sourceDir.isDirectory()) {
            throw new BizException(ErrorCode.SYSTEM_ERROR, "应用代码不存在，请先生成代码");
        }
        // 7. 复制文件到部署目录
        ...
        try {
            ...
            throw new BizException(ErrorCode.SYSTEM_ERROR, "部署失败：" + e.getMessage());
        }
